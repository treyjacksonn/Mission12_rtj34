...
function Welcome(){
  return(
    ...
    <h2>With March Madness approaching, below is a list of NCCA college basketball teams, along with their
      mascot and city/state:
    </h2>
    <br/>
    </div>
  );
...
//creates a spread of each team from the TeamNames list
function TeamList(){
  return(
    <div>
      {TeamNames.map(oneTeam => <TeamCard{...oneTeam}/>)}
    </div>
  );
}

//Takes the indivdual team and parses out the info per team that is desired
